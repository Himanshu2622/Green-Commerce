      ...
      <div className="eco_details">
        ...
        <div className="badge_details">
            <div className="popover_trigger">
                <img id='badgeToTrack' src={badge_photo} alt="" className="eco_image" onMouseEnter={showBadgePopover} onMouseLeave={hideBadgePopover}></img>
                {isBadgePopoverVisible && (
                    <div className="popover_content">
                        <div className="content">
                            <img src={badge_popover} className="popover_content_image"></img>
                        </div>
                    </div>
                )}
                {showInfoPopover && (id === "875615") && !dontShowAgain && (
                  <div className='badge_info_popover_content_nav'>
                    ...
                    <button onClick={closeInfoPopover} className='got_it'>Got It</button>
                  </div>
                )}
            </div>
